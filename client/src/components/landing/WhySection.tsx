...
const CARDS = [
  {
    span: 'col-span-12 min-[749px]:col-span-7', minH: 'min-h-[240px]', bodyMax: 'max-w-[380px]',
  ...
  {
    span: 'col-span-12 min-[749px]:col-span-5', minH: 'min-h-[240px]', bodyMax: '',
  ...
  {
    span: 'col-span-12 min-[749px]:col-span-5', minH: 'min-h-[220px]', bodyMax: '',
  ...
  {
    span: 'col-span-12 min-[749px]:col-span-7', minH: 'min-h-[220px]', bodyMax: 'max-w-[380px]',
...
export function WhySection() {
  return (
    <section className="mx-auto max-w-[1280px] px-4 md:px-8 pb-20 md:pb-28">
      ...
      >
        {CARDS.map((c) => (
          <motion.div
            ...
            className={`${c.span} ${c.minH} flex min-w-0 flex-col justify-between gap-8 md:gap-10 rounded-xl border border-[#1A1A1A] bg-[#0A0A0A] p-6 md:p-9`}
          >
            <div>
